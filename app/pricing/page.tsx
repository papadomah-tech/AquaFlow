...
const DEFAULT = { roll_cost_per_kg: 45, pkg_bulk_qty: 1000, pkg_bulk_cost: 640, water_cost_per_liter: 0.0318, liters_per_bag: 0.5, labor_per_bag: 0.50, utility_per_bag: 0.20, machine_per_bag: 0.10, transport_per_bag: 0.10, other_per_bag: 0.05, margin_pct: 20, bags_per_kg: 22 }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-4">
          <div className="card">
            ...
            <Input label="Bags per Kg (approx)" k="bags_per_kg" step="1" tip="Default: 22 bags/Kg" />
